        ...
        <div class="col-md-8">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    <h2 class="fw-bold mb-1">Add New Market Price</h2>
                    <p class="text-muted mb-4">Enter the details to add a new rice variety record to the live market map.</p>
                    ...
                    <form action="{{ route('admin.market-prices.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="rice_variety" class="form-control" placeholder="e.g., Phka Rumduol" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold text-secondary">Rice Type</label>
                                <input type="text" name="rice_type" class="form-control" placeholder="e.g., Jasmine Rice" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="province" class="form-control" placeholder="e.g., Takeo" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold text-secondary">Market Name</label>
                                <input type="text" name="market" class="form-control" placeholder="e.g., Central Market" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" name="price_per_kg" class="form-control" placeholder="0.00" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" name="change_percent" class="form-control" placeholder="0.00">
                                    <span class="input-group-text bg-light text-muted">%</span>
                                </div>
                            </div>
                        </div>
